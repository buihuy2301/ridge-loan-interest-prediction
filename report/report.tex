...
$8{,}5$ lần. Mức cải thiện đó chưa tới một bậc độ lớn, thấp xa mức tám bậc mà
\eqref{eq:gap} cho trên bài toán Ridge, nên mọi hình trong chương này có sàn cao
hơn hẳn các hình trước đó.

Cách dồn theo dòng hạ được sàn nhưng không giữ được dấu. Đo dọc một hướng ngẫu
nhiên cố định, nó trả về $-1{,}3 \cdot 10^{-16}$ ở khoảng cách $10^{-8}$ tới
$\wstar$ và $-1{,}2 \cdot 10^{-17}$ ở khoảng cách $10^{-13}$, tức đổi dấu ngay từ
điểm đầu tiên tách khỏi giá trị thật. Một giá trị âm không có chỗ trên trục
...
Trung bình $4{,}20$ không mô tả đúng phần thân lần chạy. Hình~\ref{fig:huber-cost}
cho thấy mức ổn định là 3 lần mỗi vòng và mức đó giữ tới vòng 943, sau đó đường
cong vọt lên và đạt đỉnh 36 lần ở vòng 1033. Ở phần đuôi, mức giảm thật của hàm
...
Phần đuôi đó cũng là lý do lần chạy kết thúc ở trạng thái đình trệ chứ không phải
hội tụ.
...
trăm. Newton là phương pháp duy nhất mất mát thật sự, vì tính bậc hai chính là thứ
đã cho nó một vòng lặp, và khoảng cách về số vòng giữa nó với gradient descent thu
hẹp từ 2022 lần xuống 264 lần. Hai dòng backtracking không đọc theo cách này được,
...
SGD giữ nguyên vai trò của nó và vẫn phải đọc riêng. Nó chạy 3880 vòng lô trong
$2{,}27$ giây, nhanh nhất trên mỗi đơn vị thời gian, nhưng dừng ở sai số
$3{,}1 \cdot 10^{-4}$ và không bao giờ tới $10^{-6}$, gần đúng mức
$6{,}0 \cdot 10^{-4}$ mà chương~\ref{ch:sgd} đo trên Ridge. Sàn đó do phương sai
...
vòng 52 và vòng 55. Ở cả hai chỗ đó, sai số đo được đã xuống dưới sàn của phép
trừ, và những điểm mà công thức trả về giá trị âm thì bị kẹp lên đáy trục logarit.
